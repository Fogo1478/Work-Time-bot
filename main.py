...
# 🔐 TOKEN & Webhook URL
TOKEN = os.getenv("7759525886:AAHYOL7DCL4fPR2aP7TgABv7PFUXLTjGio0")
WEBHOOK_URL = os.getenv("https://api.telegram.org/bot7759525886:AAHYOL7DCL4fPR2aP7TgABv7PFUXLTjGio0/setWebhook?url=https://worktime-bot.onrender.com/webhook")

admin_id = 2028247200
log_chat_id = -1002143893100
...
async def finalize_checkout(msg: Message, now: datetime):
    ...
    times = user_times.get(user_id)
    if not times or not isinstance(times.get("start"), datetime):
        await msg.reply("⚠️ Avval '📥 Ishga keldim' tugmasini bosing.")
        return
